        ...
        <div className="w-full bg-black min-h-screen flex flex-col items-center justify-center relative z-20 px-6 mt-[-1px]">
          <div className="text-center space-y-12">
            ...
            <div className="pt-8 flex flex-col items-center gap-8">
              ...
              <a href="https://github.com/Piyush-Fr/urbanization-prefecture" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors text-xs tracking-widest uppercase flex items-center gap-2">
